...
// import {
//   ChevronRight, ChevronUp, ShoppingCart,
//   Gift, CheckCircle, Users, Sparkles
// } from 'lucide-react';
...
//   return (
//     <div className="bg-[#fcfaf8] min-h-screen pt-28 px-6">
...
//             exit={{ y: -50, opacity: 0 }}
//             className="fixed top-0 left-1/2 -translate-x-1/2 bg-black text-white px-6 py-3 rounded-xl z-50"
//           >
//             {notification}
//           </motion.div>
//         )}
...
//           Gifts <span className="text-green-600">Collection</span>
//         </h1>
...
//           <Gift size={40} className="mx-auto mb-4 text-gray-400" />
//           <p>No Gifts Found</p>
//         </div>
//       ) : (
...
//             <div key={item.id} className="bg-white p-6 rounded-3xl shadow hover:shadow-xl transition">
